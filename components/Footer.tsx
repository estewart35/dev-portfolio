      ...
      <div className="text-muted-foreground text-sm text-pretty text-center sm:text-end">
        <div className="mb-1">
          ...
          <Link
            ...
            className="underline underline-offset-3 hover:text-logo-blue rounded-md outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] transition-all"
            target="_blank"
          >
            Next.js
          </Link>
